...
function toInkSaveData(annotations: Annotation[]): InkSaveData[] {
  return annotations
    .filter((a) => a.type === "ink")
    .map((a) => {
...
function toShapeSaveData(annotations: Annotation[]): ShapeSaveData[] {
  return annotations
...
function toTextSaveData(annotations: Annotation[]): TextSaveData[] {
  return annotations
